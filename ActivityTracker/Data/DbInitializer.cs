    ...
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var logEntries = new LogEntry[]
            {
                ...
                new LogEntry{ActivityID=2, Date=DateTime.Parse("2018-01-01"), TimeSpent=3, Notes="Lorem ipsum"},
                new LogEntry{ActivityID=2, Date=DateTime.Parse("2018-01-02"), TimeSpent=8, Notes="Dolor sit amet"},
                new LogEntry{ActivityID=2, Date=DateTime.Parse("2018-01-03"), TimeSpent=12, Notes=""},
                new LogEntry{ActivityID=3, Date=DateTime.Parse("2018-01-01"), TimeSpent=3, Notes="Lorem ipsum"},
                new LogEntry{ActivityID=3, Date=DateTime.Parse("2018-01-02"), TimeSpent=8, Notes="Dolor sit amet"},
                new LogEntry{ActivityID=3, Date=DateTime.Parse("2018-01-03"), TimeSpent=12, Notes=""},
                new LogEntry{ActivityID=5, Date=DateTime.Parse("2018-01-01"), TimeSpent=3, Notes="Lorem ipsum"},
                new LogEntry{ActivityID=5, Date=DateTime.Parse("2018-01-02"), TimeSpent=8, Notes="Dolor sit amet"},
                new LogEntry{ActivityID=5, Date=DateTime.Parse("2018-01-03"), TimeSpent=12, Notes=""},
            };
